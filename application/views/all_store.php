...
?>
        <div class="item  col-xs-2" id="<?=$value->sm_autoid?>">
            <div class="items">
                <img class="group list-group-image"  href="<?php echo base_url("admin/edit_row_sm?ty_id=$value->sm_typeid&id=$value->sm_autoid"); ?>" src="<?php echo base_url("admin/showupload/$value->sm_image"); ?>_backpage.jpg"  title="<?= $value->sm_productname; ?>" style="cursor: pointer;">
                <div class="caption" style="display: none;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <button class="btn btn-danger" onclick="deleterow(<?=$value->sm_autoid?>)"><i class="icon-trash-empty"></i></button>
                            <button class="btn btn-warning" href="<?php echo base_url("admin/edit_row_sm?ty_id=$value->sm_typeid&id=$value->sm_autoid"); ?>"><i class="icon-edit"></i></button>
                        </div>
                    </div>
                </div>
            </div>
