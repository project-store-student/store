...
<center><h3>เพิ่มสินค้าขาย</h3></center>
    <div class="line-page">
    <div class="page-grid-list">
        ...
        <a href="#" id="grid" class="btn btn-default btn-sm"><span
            ...
            <ul class="sort-item">
    <li class="sort-list"><a href="<?php echo base_url('admin/product_sale/sm_autoid/desc/1/0')?>">Highest ID</a></li>
    <li class="sort-list"><a href="<?php echo base_url('admin/product_sale/sm_autoid/asc/2/0')?>">Lowest ID</a></li>
    <li class="sort-list"><a href="<?php echo base_url('admin/product_sale/sm_amount/desc/3/0')?>">Highest Amount</a></li>
     <li class="sort-list"><a href="<?php echo base_url('admin/product_sale/sm_amount/asc/4/0')?>">Lowest Amount</a></li>
     <li class="sort-list"><a href="<?php echo base_url('admin/product_sale/sm_productname/desc/5/0')?>">A-Z</a></li>
     <li class="sort-list"><a href="<?php echo base_url('admin/product_sale/sm_productname/asc/6/0')?>">Z-A</a></li>
         </ul>
        </li>
        </ul>
        </div>
...
?>
        <div class="item   col-lg-2 col-md-3 col-sm-3 col-xs-4" id="<?=$value->sm_autoid?>">
                <img class="group list-group-image"  href="<?php echo base_url("admin/add_product_to_sale?id=$value->sm_autoid"); ?>" src="<?php echo base_url("admin/showupload/$value->sm_image"); ?>_backpage.jpg"  title="<?= $value->sm_productname; ?>" alt="<?= $value->sm_productname; ?>" style="cursor: pointer;">
                <div class="caption">
                    ...
                    <div class="row">
                            <p class="lead" style="font-size: 12px;"><label>คงเหลือ :</label> <?=$value->sm_amount?></p>
                    </div>
                      <div class="row">
                        <div class="col-md-11 col-xs-11" ></div>

                        <div class="col-md-1 col-xs-1" style="font-size: 16px;">
                            <button class="add_sale"  href="<?php echo base_url("admin/add_product_to_sale?id=$value->sm_autoid"); ?>"><i class="icon-bitcoin"></i></button>
