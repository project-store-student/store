                                                            ...
                                                            <td width="570px">
                                                                <table style="width:570px;margin:0px auto;padding:0px;background-color:#fff">
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <td style="border-radius:3px;vertical-align:middle;text-align:center" align="center" valign="middle" nowrap="" bgcolor="#FF0046" width="100" height="50"><a href="<?php echo base_url("my_customer/activate_customer?token=$key->temp_token"); ?>">Click here to change your password.</a></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td height="5px">&nbsp;</td>
                                                                        </tr>
