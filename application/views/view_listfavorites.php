...
<div style="margin:100px;">
    ...
    <section class=""  style="margin-top: 15px; overflow: hidden;">
            <div id="row-main">
                <div id="sidebar" class="col-md-3 collapsed-fa">
...
//                    echo "</pre>";
                    ?>
                    <div id="content" class="col-md-3" style="padding-left: 0px;">
...
//        });
        ...
        $('#btn-create').on("click", function () {
            ...
            $("#sidebar").toggleClass("collapsed-fa");
