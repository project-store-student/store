...
<div  style="width: calc(100% - 179px); margin: 75px 89.500px 75px 89.500px;">
    <h1><i class="icon-newspaper-1"></i>ใบเสร็จ : <small><?php echo $txn_id; ?></small></h1>
    <hr>
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" style="float: right;">
            <div class="row">
                <h4 style="float: right; margin: 0px 15px 5px 0px"><?php echo $txn_id; ?> <small> <?php echo $show_payment_date; ?></small></h4>
            </div>
            <div class="row">
                <h6 style="float: right; margin: 0px 15px 0px 0px;">คำสั่งซื้อได้ถูกชำระเมื่อ : <small><?php echo $show_payment_date; ?></small></h6>
            </div>
            <div class="row">
                <button onClick="window.open('<?php echo base_url("my_customer/print_receipt?txt_id=$txn_id"); ?>');" style="float: right; margin: 15px " class="btn bg-gray hvr-shutter-out-horizontal" type="button"><i class="icon-print"> </i> พิมพ์ </button>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="alert alert-info alert-dismissable">
                ...
                คำสั่งซื้อได้ถูก<strong>ชำระแล้ว</strong> เลขที่ใบเสร็จของคุณคือ : <?php echo $txn_id; ?> 
            </div>
        </div>
    </div>
    <hr>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td id="td" class="th"><?php echo $payment_gross; ?></td>
