...
<!--	<meta name="viewport" content="initial-scale=1.0, maximum-scale=2.0">-->
	...
	<link rel="stylesheet" type="text/css" href="<?php echo base_url("assets/DataTables/examples/resources/demo.css"); ?>">
	...
	<script type="text/javascript" language="javascript" src="<?php echo base_url("assets/DataTables/examples/resources/syntax/shCore.js"); ?>">
	</script>
	<script type="text/javascript" language="javascript" src="<?php echo base_url("assets/DataTables/examples/resources/demo.js"); ?>">
	</script>
